 ...
 * поддержкой состояния загрузки и иконок.
 */
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 focus:ring-primary-500 disabled:hover:bg-white',
    danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 disabled:hover:bg-red-600',
    ghost: 'text-gray-700 hover:bg-gray-100 focus:ring-primary-500 disabled:hover:bg-transparent',
  }
